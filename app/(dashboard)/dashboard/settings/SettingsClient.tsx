  ...
  return (
    <div className="p-8 max-w-3xl">
      <div className="mb-8">
        ...
        <p className="text-neutral-500 mt-1">Administrá tu plan y suscripción.</p>
      </div>
            ...
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="shrink-0">
                  {isCurrent ? (
                    <div className="px-4 py-2 text-sm text-neutral-400 border border-neutral-200 rounded-lg">
                      Plan actual
                    </div>
                  ) : (
                    <button
